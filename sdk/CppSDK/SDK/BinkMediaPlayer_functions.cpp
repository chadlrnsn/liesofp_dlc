...
// Function BinkMediaPlayer.BinkMediaPlayer.DeactivatePauseOnReachedEnd
// (Final, Native, Public, BlueprintCallable)

void UBinkMediaPlayer::DeactivatePauseOnReachedEnd()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BinkMediaPlayer", "DeactivatePauseOnReachedEnd");
...
bool UBinkMediaPlayer::IsPauseOnReachedEnd()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BinkMediaPlayer", "IsPauseOnReachedEnd");

	Params::BinkMediaPlayer_IsPauseOnReachedEnd Parms{};
...
// Function BinkMediaPlayer.BinkMediaPlayer.ReservePauseOnReachedEnd
// (Final, Native, Public, BlueprintCallable)

void UBinkMediaPlayer::ReservePauseOnReachedEnd()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BinkMediaPlayer", "ReservePauseOnReachedEnd");
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// float                                   DeltaTimeFromEnd                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UBinkMediaPlayer::SeekToLast(float DeltaTimeFromEnd)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BinkMediaPlayer", "SeekToLast");

	Params::BinkMediaPlayer_SeekToLast Parms{};

	Parms.DeltaTimeFromEnd = DeltaTimeFromEnd;
