...
public:
	void OnActive__DelegateSignature(class UUIW_Btn_Key_RIght_C* BtnKey);
	void OnStartHold__DelegateSignature();
	void OnCancelHold__DelegateSignature();
	void OnAxis__DelegateSignature(class UUIW_Btn_Key_RIght_C* BtnKey, float AxisX_0, float AxisY_0, float AxisXY, float Angle);
	void OnScroll__DelegateSignature(float Delta);
	void OnRepeat__DelegateSignature(class UUIW_Btn_Key_RIght_C* BtnKey);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"UIW_Btn_Key_RIght_C">();
	}
...
static_assert(alignof(UUIW_Btn_Key_RIght_C) == 0x000008, "Wrong alignment on UUIW_Btn_Key_RIght_C");
static_assert(sizeof(UUIW_Btn_Key_RIght_C) == 0x0003D0, "Wrong size on UUIW_Btn_Key_RIght_C");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, UberGraphFrame) == 0x0002A8, "Member 'UUIW_Btn_Key_RIght_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, Btn) == 0x0002B0, "Member 'UUIW_Btn_Key_RIght_C::Btn' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, Circle) == 0x0002B8, "Member 'UUIW_Btn_Key_RIght_C::Circle' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, CircleBG) == 0x0002C0, "Member 'UUIW_Btn_Key_RIght_C::CircleBG' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, HoldGroup) == 0x0002C8, "Member 'UUIW_Btn_Key_RIght_C::HoldGroup' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, Icon) == 0x0002D0, "Member 'UUIW_Btn_Key_RIght_C::Icon' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, Img_Arrow) == 0x0002D8, "Member 'UUIW_Btn_Key_RIght_C::Img_Arrow' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, Quadrangle) == 0x0002E0, "Member 'UUIW_Btn_Key_RIght_C::Quadrangle' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, QuadrangleBG) == 0x0002E8, "Member 'UUIW_Btn_Key_RIght_C::QuadrangleBG' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, SelectedBG) == 0x0002F0, "Member 'UUIW_Btn_Key_RIght_C::SelectedBG' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, Text_Label) == 0x0002F8, "Member 'UUIW_Btn_Key_RIght_C::Text_Label' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, TextGroup) == 0x000300, "Member 'UUIW_Btn_Key_RIght_C::TextGroup' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, CurrentProgress) == 0x000308, "Member 'UUIW_Btn_Key_RIght_C::CurrentProgress' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, GaugeTimer) == 0x000310, "Member 'UUIW_Btn_Key_RIght_C::GaugeTimer' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, HoldTime) == 0x000318, "Member 'UUIW_Btn_Key_RIght_C::HoldTime' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, OnActive) == 0x000320, "Member 'UUIW_Btn_Key_RIght_C::OnActive' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, TargetGauge) == 0x000330, "Member 'UUIW_Btn_Key_RIght_C::TargetGauge' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, InputName) == 0x000338, "Member 'UUIW_Btn_Key_RIght_C::InputName' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, OnRepeat) == 0x000340, "Member 'UUIW_Btn_Key_RIght_C::OnRepeat' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, OnStartHold) == 0x000350, "Member 'UUIW_Btn_Key_RIght_C::OnStartHold' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, OnCancelHold) == 0x000360, "Member 'UUIW_Btn_Key_RIght_C::OnCancelHold' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, OnAxis) == 0x000370, "Member 'UUIW_Btn_Key_RIght_C::OnAxis' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, AxisX) == 0x000380, "Member 'UUIW_Btn_Key_RIght_C::AxisX' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, AxisY) == 0x000384, "Member 'UUIW_Btn_Key_RIght_C::AxisY' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, InputType) == 0x000388, "Member 'UUIW_Btn_Key_RIght_C::InputType' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, OnScroll) == 0x000390, "Member 'UUIW_Btn_Key_RIght_C::OnScroll' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, IsViewContents) == 0x0003A0, "Member 'UUIW_Btn_Key_RIght_C::IsViewContents' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, VisibleType) == 0x0003A1, "Member 'UUIW_Btn_Key_RIght_C::VisibleType' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, Label) == 0x0003A8, "Member 'UUIW_Btn_Key_RIght_C::Label' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, IgnoreCount) == 0x0003C0, "Member 'UUIW_Btn_Key_RIght_C::IgnoreCount' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, IgnoreCount_Repeat) == 0x0003C4, "Member 'UUIW_Btn_Key_RIght_C::IgnoreCount_Repeat' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, IgnoreCount_Repeat_Delay) == 0x0003C8, "Member 'UUIW_Btn_Key_RIght_C::IgnoreCount_Repeat_Delay' has a wrong offset!");
static_assert(offsetof(UUIW_Btn_Key_RIght_C, IsPressed) == 0x0003CC, "Member 'UUIW_Btn_Key_RIght_C::IsPressed' has a wrong offset!");
