...
// 0x00A0 (0x1CC8 - 0x1C28)
class UIpConnection : public UNetConnection
{
public:
	uint8                                         Pad_1C28[0x50];                                    // 0x1C28(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SocketErrorDisconnectDelay;                        // 0x1C78(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1C7C[0x4C];                                    // 0x1C7C(0x004C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpConnection) == 0x001CC8, "Wrong size on UIpConnection");
static_assert(offsetof(UIpConnection, SocketErrorDisconnectDelay) == 0x001C78, "Member 'UIpConnection::SocketErrorDisconnectDelay' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_7C0[0xC];                                      // 0x07C0(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7F0[0x38];                                     // 0x07F0(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpNetDriver) == 0x000828, "Wrong size on UIpNetDriver");
...
public:
	...
	float                                         BeaconConnectionInitialTimeout;                    // 0x01E8(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         BeaconConnectionTimeout;                           // 0x01EC(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UNetDriver*                             NetDriver;                                         // 0x01F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AOnlineBeacon) == 0x000210, "Wrong size on AOnlineBeacon");
static_assert(offsetof(AOnlineBeacon, BeaconConnectionInitialTimeout) == 0x0001E8, "Member 'AOnlineBeacon::BeaconConnectionInitialTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, BeaconConnectionTimeout) == 0x0001EC, "Member 'AOnlineBeacon::BeaconConnectionTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, NetDriver) == 0x0001F0, "Member 'AOnlineBeacon::NetDriver' has a wrong offset!");
...
{
public:
	int32                                         ListenPort;                                        // 0x0210(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_214[0x4];                                      // 0x0214(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x0218(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_228[0xA0];                                     // 0x0228(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AOnlineBeaconHost) == 0x0002C8, "Wrong size on AOnlineBeaconHost");
static_assert(offsetof(AOnlineBeaconHost, ListenPort) == 0x000210, "Member 'AOnlineBeaconHost::ListenPort' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, ClientActors) == 0x000218, "Member 'AOnlineBeaconHost::ClientActors' has a wrong offset!");
...
{
public:
	class FString                                 BeaconTypeName;                                    // 0x01E0(0x0010)(ZeroConstructor, Transient, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class AOnlineBeaconClient>        ClientBeaconActorClass;                            // 0x01F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x01F8(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AOnlineBeaconHostObject) == 0x000208, "Wrong size on AOnlineBeaconHostObject");
static_assert(offsetof(AOnlineBeaconHostObject, BeaconTypeName) == 0x0001E0, "Member 'AOnlineBeaconHostObject::BeaconTypeName' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHostObject, ClientBeaconActorClass) == 0x0001F0, "Member 'AOnlineBeaconHostObject::ClientBeaconActorClass' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHostObject, ClientActors) == 0x0001F8, "Member 'AOnlineBeaconHostObject::ClientActors' has a wrong offset!");
...
{
public:
	class UPartyBeaconState*                      State;                                             // 0x0208(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_210[0x60];                                     // 0x0210(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bLogoutOnSessionTimeout;                           // 0x0270(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_271[0x3];                                      // 0x0271(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SessionTimeoutSecs;                                // 0x0274(0x0004)(ZeroConstructor, Transient, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         TravelSessionTimeoutSecs;                          // 0x0278(0x0004)(ZeroConstructor, Transient, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(APartyBeaconHost) == 0x000280, "Wrong size on APartyBeaconHost");
static_assert(offsetof(APartyBeaconHost, State) == 0x000208, "Member 'APartyBeaconHost::State' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, bLogoutOnSessionTimeout) == 0x000270, "Member 'APartyBeaconHost::bLogoutOnSessionTimeout' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, SessionTimeoutSecs) == 0x000274, "Member 'APartyBeaconHost::SessionTimeoutSecs' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, TravelSessionTimeoutSecs) == 0x000278, "Member 'APartyBeaconHost::TravelSessionTimeoutSecs' has a wrong offset!");
...
{
public:
	class AOnlineBeaconHostObject*                BeaconOwner;                                       // 0x0210(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UNetConnection*                         BeaconConnection;                                  // 0x0218(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EBeaconConnectionState                        ConnectionState;                                   // 0x0220(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AOnlineBeaconClient) == 0x000270, "Wrong size on AOnlineBeaconClient");
static_assert(offsetof(AOnlineBeaconClient, BeaconOwner) == 0x000210, "Member 'AOnlineBeaconClient::BeaconOwner' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, BeaconConnection) == 0x000218, "Member 'AOnlineBeaconClient::BeaconConnection' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, ConnectionState) == 0x000220, "Member 'AOnlineBeaconClient::ConnectionState' has a wrong offset!");
...
public:
	...
	class FString                                 DestSessionId;                                     // 0x02A0(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FPartyReservation                      PendingReservation;                                // 0x02B0(0x0050)(Protected, NativeAccessSpecifierProtected)
	EClientRequestType                            RequestType;                                       // 0x0300(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bPendingReservationSent;                           // 0x0301(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bCancelReservation;                                // 0x0302(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_303[0x2D];                                     // 0x0303(0x002D)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(APartyBeaconClient) == 0x000330, "Wrong size on APartyBeaconClient");
static_assert(offsetof(APartyBeaconClient, DestSessionId) == 0x0002A0, "Member 'APartyBeaconClient::DestSessionId' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, PendingReservation) == 0x0002B0, "Member 'APartyBeaconClient::PendingReservation' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, RequestType) == 0x000300, "Member 'APartyBeaconClient::RequestType' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bPendingReservationSent) == 0x000301, "Member 'APartyBeaconClient::bPendingReservationSent' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bCancelReservation) == 0x000302, "Member 'APartyBeaconClient::bCancelReservation' has a wrong offset!");
...
public:
	uint8                                         Pad_270[0x30];                                     // 0x0270(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 DestSessionId;                                     // 0x02A0(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FSpectatorReservation                  PendingReservation;                                // 0x02B0(0x0078)(Protected, NativeAccessSpecifierProtected)
	ESpectatorClientRequestType                   RequestType;                                       // 0x0328(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ASpectatorBeaconClient) == 0x000358, "Wrong size on ASpectatorBeaconClient");
static_assert(offsetof(ASpectatorBeaconClient, DestSessionId) == 0x0002A0, "Member 'ASpectatorBeaconClient::DestSessionId' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, PendingReservation) == 0x0002B0, "Member 'ASpectatorBeaconClient::PendingReservation' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, RequestType) == 0x000328, "Member 'ASpectatorBeaconClient::RequestType' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, bPendingReservationSent) == 0x000329, "Member 'ASpectatorBeaconClient::bPendingReservationSent' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, bCancelReservation) == 0x00032A, "Member 'ASpectatorBeaconClient::bCancelReservation' has a wrong offset!");
...
{
public:
	class USpectatorBeaconState*                  State;                                             // 0x0208(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_210[0x60];                                     // 0x0210(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bLogoutOnSessionTimeout;                           // 0x0270(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_271[0x3];                                      // 0x0271(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SessionTimeoutSecs;                                // 0x0274(0x0004)(ZeroConstructor, Transient, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ASpectatorBeaconHost) == 0x000280, "Wrong size on ASpectatorBeaconHost");
static_assert(offsetof(ASpectatorBeaconHost, State) == 0x000208, "Member 'ASpectatorBeaconHost::State' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconHost, bLogoutOnSessionTimeout) == 0x000270, "Member 'ASpectatorBeaconHost::bLogoutOnSessionTimeout' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconHost, SessionTimeoutSecs) == 0x000274, "Member 'ASpectatorBeaconHost::SessionTimeoutSecs' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconHost, TravelSessionTimeoutSecs) == 0x000278, "Member 'ASpectatorBeaconHost::TravelSessionTimeoutSecs' has a wrong offset!");
...
static_assert(sizeof(ATestBeaconClient) == 0x000270, "Wrong size on ATestBeaconClient");
...
static_assert(sizeof(ATestBeaconHost) == 0x000208, "Wrong size on ATestBeaconHost");
...
{
public:
	uint8                                         Pad_6B0[0x60];                                     // 0x06B0(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UVoipListenerSynthComponent) == 0x000710, "Wrong size on UVoipListenerSynthComponent");
