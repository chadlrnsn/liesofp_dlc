...
public:
	...
	FMulticastInlineDelegateProperty_             OnPauseOnReachedEnd;                               // 0x0100(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	bool Pause();
	bool Play();
	void ReservePauseOnReachedEnd();
	bool Rewind();
	bool Seek(const struct FTimespan& InTime);
	void SeekToLast(float DeltaTimeFromEnd);
...
static_assert(offsetof(UBinkMediaPlayer, OnPauseOnReachedEnd) == 0x000100, "Member 'UBinkMediaPlayer::OnPauseOnReachedEnd' has a wrong offset!");
