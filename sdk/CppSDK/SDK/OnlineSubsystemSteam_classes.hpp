...
static_assert(sizeof(USteamNetDriver) == 0x000830, "Wrong size on USteamNetDriver");
...
{
public:
	bool                                          bIsPassthrough;                                    // 0x1CC8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USteamNetConnection) == 0x001CD0, "Wrong size on USteamNetConnection");
static_assert(offsetof(USteamNetConnection, bIsPassthrough) == 0x001CC8, "Member 'USteamNetConnection::bIsPassthrough' has a wrong offset!");
