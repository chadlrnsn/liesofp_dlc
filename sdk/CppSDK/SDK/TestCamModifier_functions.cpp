...
#include "TestCamModifier_classes.hpp"
#include "TestCamModifier_parameters.hpp"
...
void UTestCamModifier_C::BlueprintModifyCamera(float DeltaTime, const struct FVector& ViewLocation, const struct FRotator& ViewRotation, float FOV, struct FVector* NewViewLocation, struct FRotator* NewViewRotation, float* NewFOV)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TestCamModifier_C", "BlueprintModifyCamera");

	Params::TestCamModifier_C_BlueprintModifyCamera Parms{};
