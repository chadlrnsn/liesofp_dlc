...
static_assert(sizeof(FAnimNode_KawaiiPhysics) == 0x0008A0, "Wrong size on FAnimNode_KawaiiPhysics");
...
static_assert(offsetof(FAnimNode_KawaiiPhysics, bEnableWind) == 0x0004F4, "Member 'FAnimNode_KawaiiPhysics::bEnableWind' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, WindScale) == 0x0004F8, "Member 'FAnimNode_KawaiiPhysics::WindScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, WindSpeedLimit) == 0x0004FC, "Member 'FAnimNode_KawaiiPhysics::WindSpeedLimit' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, AdditionalVelocity_LocalAxis_X) == 0x000500, "Member 'FAnimNode_KawaiiPhysics::AdditionalVelocity_LocalAxis_X' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, AdditionalVelocity_LocalAxis_Y) == 0x000588, "Member 'FAnimNode_KawaiiPhysics::AdditionalVelocity_LocalAxis_Y' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, AdditionalVelocity_LocalAxis_Z) == 0x000610, "Member 'FAnimNode_KawaiiPhysics::AdditionalVelocity_LocalAxis_Z' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, WorldMovementScale) == 0x00069C, "Member 'FAnimNode_KawaiiPhysics::WorldMovementScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, WorldRotationScale) == 0x0006A0, "Member 'FAnimNode_KawaiiPhysics::WorldRotationScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, bAllowWorldCollision) == 0x0006A4, "Member 'FAnimNode_KawaiiPhysics::bAllowWorldCollision' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, bOverrideCollisionParams) == 0x0006A5, "Member 'FAnimNode_KawaiiPhysics::bOverrideCollisionParams' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, CollisionChannelSettings) == 0x0006A8, "Member 'FAnimNode_KawaiiPhysics::CollisionChannelSettings' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, bIgnoreSelfComponent) == 0x000800, "Member 'FAnimNode_KawaiiPhysics::bIgnoreSelfComponent' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, IgnoreBones) == 0x000808, "Member 'FAnimNode_KawaiiPhysics::IgnoreBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, IgnoreBoneNamePrefix) == 0x000818, "Member 'FAnimNode_KawaiiPhysics::IgnoreBoneNamePrefix' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, ModifyBones) == 0x000828, "Member 'FAnimNode_KawaiiPhysics::ModifyBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, TotalBoneLength) == 0x000838, "Member 'FAnimNode_KawaiiPhysics::TotalBoneLength' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, PreSkelCompTransform) == 0x000840, "Member 'FAnimNode_KawaiiPhysics::PreSkelCompTransform' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, bInitPhysicsSettings) == 0x000870, "Member 'FAnimNode_KawaiiPhysics::bInitPhysicsSettings' has a wrong offset!");
