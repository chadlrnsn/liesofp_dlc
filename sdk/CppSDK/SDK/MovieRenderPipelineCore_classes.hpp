...
static_assert(sizeof(AMoviePipelineGameMode) == 0x000280, "Wrong size on AMoviePipelineGameMode");
...
static_assert(sizeof(UMovieRenderDebugWidget) == 0x000268, "Wrong size on UMovieRenderDebugWidget");
