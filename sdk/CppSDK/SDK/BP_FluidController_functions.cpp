...
void ABP_FluidController_C::CollectSurfaceBounds()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_FluidController_C", "CollectSurfaceBounds");
...
void ABP_FluidController_C::IsInAnySurface(bool* Value)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_FluidController_C", "IsInAnySurface");

	Params::BP_FluidController_C_IsInAnySurface Parms{};
