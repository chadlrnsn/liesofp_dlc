...
{
public:
	struct FSoftObjectPath                        LevelVariantSets;                                  // 0x01E0(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class UClass*, class ULevelVariantSetsFunctionDirector*> DirectorInstances;                                 // 0x01F8(0x0050)(Transient, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(ALevelVariantSetsActor, LevelVariantSets) == 0x0001E0, "Member 'ALevelVariantSetsActor::LevelVariantSets' has a wrong offset!");
static_assert(offsetof(ALevelVariantSetsActor, DirectorInstances) == 0x0001F8, "Member 'ALevelVariantSetsActor::DirectorInstances' has a wrong offset!");
...
public:
	...
	class USceneComponent*                        SceneComponent;                                    // 0x01F8(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         LastSelectedOption;                                // 0x0200(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(ASwitchActor) == 0x000208, "Wrong size on ASwitchActor");
static_assert(offsetof(ASwitchActor, SceneComponent) == 0x0001F8, "Member 'ASwitchActor::SceneComponent' has a wrong offset!");
static_assert(offsetof(ASwitchActor, LastSelectedOption) == 0x000200, "Member 'ASwitchActor::LastSelectedOption' has a wrong offset!");
