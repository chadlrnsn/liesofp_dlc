...
static_assert(offsetof(UAnimBoneCompressionCodec_ACLBase, bStripBindPose) == 0x000038, "Member 'UAnimBoneCompressionCodec_ACLBase::bStripBindPose' has a wrong offset!");
