...
// 0x06C0 (0x0D70 - 0x06B0)
class UModularSynthComponent final : public USynthComponent
{
public:
	int32                                         VoiceCount;                                        // 0x06B0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6B4[0x6BC];                                    // 0x06B4(0x06BC)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UModularSynthComponent) == 0x000D70, "Wrong size on UModularSynthComponent");
static_assert(offsetof(UModularSynthComponent, VoiceCount) == 0x0006B0, "Member 'UModularSynthComponent::VoiceCount' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnMouseCaptureBegin;                               // 0x0410(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMouseCaptureEnd;                                 // 0x0420(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnControllerCaptureBegin;                          // 0x0430(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnControllerCaptureEnd;                            // 0x0440(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnValueChangedX;                                   // 0x0450(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnValueChangedY;                                   // 0x0460(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	class USoundWave*                             GranulatedSoundWave;                               // 0x06B0(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_6B8[0x3B8];                                    // 0x06B8(0x03B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UGranularSynth) == 0x000A70, "Wrong size on UGranularSynth");
static_assert(offsetof(UGranularSynth, GranulatedSoundWave) == 0x0006B0, "Member 'UGranularSynth::GranulatedSoundWave' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnTableAltered;                                    // 0x06B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnNumTablesChanged;                                // 0x06C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class UMonoWaveTableSynthPreset*              CurrentPreset;                                     // 0x06D0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_6D8[0x718];                                    // 0x06D8(0x0718)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USynthComponentMonoWaveTable) == 0x000DF0, "Wrong size on USynthComponentMonoWaveTable");
static_assert(offsetof(USynthComponentMonoWaveTable, OnTableAltered) == 0x0006B0, "Member 'USynthComponentMonoWaveTable::OnTableAltered' has a wrong offset!");
static_assert(offsetof(USynthComponentMonoWaveTable, OnNumTablesChanged) == 0x0006C0, "Member 'USynthComponentMonoWaveTable::OnNumTablesChanged' has a wrong offset!");
static_assert(offsetof(USynthComponentMonoWaveTable, CurrentPreset) == 0x0006D0, "Member 'USynthComponentMonoWaveTable::CurrentPreset' has a wrong offset!");
...
{
public:
	float                                         Frequency;                                         // 0x06B0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Volume;                                            // 0x06B4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USynthComponentToneGenerator) == 0x0006D0, "Wrong size on USynthComponentToneGenerator");
static_assert(offsetof(USynthComponentToneGenerator, Frequency) == 0x0006B0, "Member 'USynthComponentToneGenerator::Frequency' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, Volume) == 0x0006B4, "Member 'USynthComponentToneGenerator::Volume' has a wrong offset!");

// Class Synthesis.SynthSamplePlayer
// 0x0130 (0x07E0 - 0x06B0)
class USynthSamplePlayer final : public USynthComponent
{
public:
	class USoundWave*                             SoundWave;                                         // 0x06B0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSampleLoaded;                                    // 0x06B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSamplePlaybackProgress;                          // 0x06C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_6D8[0x108];                                    // 0x06D8(0x0108)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USynthSamplePlayer) == 0x0007E0, "Wrong size on USynthSamplePlayer");
static_assert(offsetof(USynthSamplePlayer, SoundWave) == 0x0006B0, "Member 'USynthSamplePlayer::SoundWave' has a wrong offset!");
static_assert(offsetof(USynthSamplePlayer, OnSampleLoaded) == 0x0006B8, "Member 'USynthSamplePlayer::OnSampleLoaded' has a wrong offset!");
static_assert(offsetof(USynthSamplePlayer, OnSamplePlaybackProgress) == 0x0006C8, "Member 'USynthSamplePlayer::OnSamplePlaybackProgress' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnMouseCaptureBegin;                               // 0x03A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMouseCaptureEnd;                                 // 0x03B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnControllerCaptureBegin;                          // 0x03C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnControllerCaptureEnd;                            // 0x03D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnValueChanged;                                    // 0x03E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
