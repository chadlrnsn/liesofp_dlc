...
{
public:
	class UDestructibleComponent*                 DestructibleComponent;                             // 0x01E0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             OnActorFracture;                                   // 0x01E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ADestructibleActor) == 0x0001F8, "Wrong size on ADestructibleActor");
static_assert(offsetof(ADestructibleActor, DestructibleComponent) == 0x0001E0, "Member 'ADestructibleActor::DestructibleComponent' has a wrong offset!");
static_assert(offsetof(ADestructibleActor, OnActorFracture) == 0x0001E8, "Member 'ADestructibleActor::OnActorFracture' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnComponentFracture;                               // 0x06B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_6C0[0x90];                                     // 0x06C0(0x0090)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDestructibleComponent) == 0x000750, "Wrong size on UDestructibleComponent");
...
static_assert(offsetof(UDestructibleComponent, OnComponentFracture) == 0x0006B0, "Member 'UDestructibleComponent::OnComponentFracture' has a wrong offset!");
...
static_assert(sizeof(UDestructibleFractureSettings) == 0x000090, "Wrong size on UDestructibleFractureSettings");
...
static_assert(offsetof(UDestructibleMesh, SourceStaticMesh) == 0x000438, "Member 'UDestructibleMesh::SourceStaticMesh' has a wrong offset!");
