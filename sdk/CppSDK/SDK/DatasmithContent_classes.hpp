...
{
public:
	EComponentMobility                            Mobility;                                          // 0x01E0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EDatasmithAreaLightActorType                  LightType;                                         // 0x01E1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EDatasmithAreaLightActorShape                 LightShape;                                        // 0x01E2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E3[0x1];                                      // 0x01E3(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              Dimensions;                                        // 0x01E4(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Intensity;                                         // 0x01EC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ELightUnits                                   IntensityUnits;                                    // 0x01F0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	float                                         Temperature;                                       // 0x0204(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTextureLightProfile*                   IESTexture;                                        // 0x0208(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseIESBrightness;                                 // 0x0210(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_211[0x3];                                      // 0x0211(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         IESBrightnessScale;                                // 0x0214(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               Rotation;                                          // 0x0218(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         SourceRadius;                                      // 0x0224(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SourceLength;                                      // 0x0228(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AttenuationRadius;                                 // 0x022C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SpotlightInnerAngle;                               // 0x0230(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SpotlightOuterAngle;                               // 0x0234(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ADatasmithAreaLightActor) == 0x000238, "Wrong size on ADatasmithAreaLightActor");
static_assert(offsetof(ADatasmithAreaLightActor, Mobility) == 0x0001E0, "Member 'ADatasmithAreaLightActor::Mobility' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, LightType) == 0x0001E1, "Member 'ADatasmithAreaLightActor::LightType' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, LightShape) == 0x0001E2, "Member 'ADatasmithAreaLightActor::LightShape' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Dimensions) == 0x0001E4, "Member 'ADatasmithAreaLightActor::Dimensions' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Intensity) == 0x0001EC, "Member 'ADatasmithAreaLightActor::Intensity' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, IntensityUnits) == 0x0001F0, "Member 'ADatasmithAreaLightActor::IntensityUnits' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Color) == 0x0001F4, "Member 'ADatasmithAreaLightActor::Color' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Temperature) == 0x000204, "Member 'ADatasmithAreaLightActor::Temperature' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, IESTexture) == 0x000208, "Member 'ADatasmithAreaLightActor::IESTexture' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, bUseIESBrightness) == 0x000210, "Member 'ADatasmithAreaLightActor::bUseIESBrightness' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, IESBrightnessScale) == 0x000214, "Member 'ADatasmithAreaLightActor::IESBrightnessScale' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Rotation) == 0x000218, "Member 'ADatasmithAreaLightActor::Rotation' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, SourceRadius) == 0x000224, "Member 'ADatasmithAreaLightActor::SourceRadius' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, SourceLength) == 0x000228, "Member 'ADatasmithAreaLightActor::SourceLength' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, AttenuationRadius) == 0x00022C, "Member 'ADatasmithAreaLightActor::AttenuationRadius' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, SpotlightInnerAngle) == 0x000230, "Member 'ADatasmithAreaLightActor::SpotlightInnerAngle' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, SpotlightOuterAngle) == 0x000234, "Member 'ADatasmithAreaLightActor::SpotlightOuterAngle' has a wrong offset!");
...
{
public:
	TArray<class ULevelSequence*>                 ImportedSequences;                                 // 0x01E0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ADatasmithImportedSequencesActor) == 0x0001F0, "Wrong size on ADatasmithImportedSequencesActor");
static_assert(offsetof(ADatasmithImportedSequencesActor, ImportedSequences) == 0x0001E0, "Member 'ADatasmithImportedSequencesActor::ImportedSequences' has a wrong offset!");
...
{
public:
	class UDatasmithScene*                        Scene;                                             // 0x01E0(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FName, TSoftObjectPtr<class AActor>> RelatedActors;                                     // 0x01E8(0x0050)(Edit, EditConst, AdvancedDisplay, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ADatasmithSceneActor) == 0x000238, "Wrong size on ADatasmithSceneActor");
static_assert(offsetof(ADatasmithSceneActor, Scene) == 0x0001E0, "Member 'ADatasmithSceneActor::Scene' has a wrong offset!");
static_assert(offsetof(ADatasmithSceneActor, RelatedActors) == 0x0001E8, "Member 'ADatasmithSceneActor::RelatedActors' has a wrong offset!");
