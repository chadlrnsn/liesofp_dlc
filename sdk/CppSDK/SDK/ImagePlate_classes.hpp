...
{
public:
	class UImagePlateComponent*                   ImagePlate;                                        // 0x01E0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AImagePlate) == 0x0001E8, "Wrong size on AImagePlate");
static_assert(offsetof(AImagePlate, ImagePlate) == 0x0001E0, "Member 'AImagePlate::ImagePlate' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_478[0x89];                                     // 0x0478(0x0089)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bUpdateOnlyIfRendered;                             // 0x0501(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UImagePlateComponent, bUpdateOnlyIfRendered) == 0x000501, "Member 'UImagePlateComponent::bUpdateOnlyIfRendered' has a wrong offset!");
