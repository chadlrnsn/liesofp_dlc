...
static_assert(sizeof(APreviewGeometryActor) == 0x0001E0, "Wrong size on APreviewGeometryActor");
...
static_assert(sizeof(APreviewMeshActor) == 0x0001E0, "Wrong size on APreviewMeshActor");
