...
// Function BinkMediaPlayer.BinkMediaPlayer.IsPauseOnReachedEnd
// 0x0001 (0x0001 - 0x0000)
struct BinkMediaPlayer_IsPauseOnReachedEnd final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(BinkMediaPlayer_IsPauseOnReachedEnd) == 0x000001, "Wrong alignment on BinkMediaPlayer_IsPauseOnReachedEnd");
static_assert(sizeof(BinkMediaPlayer_IsPauseOnReachedEnd) == 0x000001, "Wrong size on BinkMediaPlayer_IsPauseOnReachedEnd");
static_assert(offsetof(BinkMediaPlayer_IsPauseOnReachedEnd, ReturnValue) == 0x000000, "Member 'BinkMediaPlayer_IsPauseOnReachedEnd::ReturnValue' has a wrong offset!");
...
// Function BinkMediaPlayer.BinkMediaPlayer.SeekToLast
// 0x0004 (0x0004 - 0x0000)
struct BinkMediaPlayer_SeekToLast final
{
public:
	float                                         DeltaTimeFromEnd;                                  // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(BinkMediaPlayer_SeekToLast) == 0x000004, "Wrong alignment on BinkMediaPlayer_SeekToLast");
static_assert(sizeof(BinkMediaPlayer_SeekToLast) == 0x000004, "Wrong size on BinkMediaPlayer_SeekToLast");
static_assert(offsetof(BinkMediaPlayer_SeekToLast, DeltaTimeFromEnd) == 0x000000, "Member 'BinkMediaPlayer_SeekToLast::DeltaTimeFromEnd' has a wrong offset!");
