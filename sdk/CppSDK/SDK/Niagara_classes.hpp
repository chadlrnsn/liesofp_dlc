...
{
public:
	class UNiagaraComponent*                      NiagaraComponent;                                  // 0x01E0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bDestroyOnSystemFinish : 1;                        // 0x01E8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(sizeof(ANiagaraActor) == 0x0001F0, "Wrong size on ANiagaraActor");
static_assert(offsetof(ANiagaraActor, NiagaraComponent) == 0x0001E0, "Member 'ANiagaraActor::NiagaraComponent' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_593[0x4D];                                     // 0x0593(0x004D)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraEffectType*                     RegisteredEffectType;                              // 0x05E0(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_5E8[0x20];                                     // 0x05E8(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UNiagaraComponent, RegisteredEffectType) == 0x0005E0, "Member 'UNiagaraComponent::RegisteredEffectType' has a wrong offset!");
...
static_assert(offsetof(UNiagaraEmitter, UniqueEmitterName) == 0x000180, "Member 'UNiagaraEmitter::UniqueEmitterName' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, RendererProperties) == 0x000190, "Member 'UNiagaraEmitter::RendererProperties' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, EventHandlerScriptProps) == 0x0001A0, "Member 'UNiagaraEmitter::EventHandlerScriptProps' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, SimulationStages) == 0x0001B0, "Member 'UNiagaraEmitter::SimulationStages' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, GPUComputeScript) == 0x0001C0, "Member 'UNiagaraEmitter::GPUComputeScript' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, SharedEventGeneratorIds) == 0x0001C8, "Member 'UNiagaraEmitter::SharedEventGeneratorIds' has a wrong offset!");
...
{
public:
	class UNiagaraBaselineController*             Controller;                                        // 0x01E0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTextRenderComponent*                   Label;                                             // 0x01E8(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ANiagaraPerfBaselineActor) == 0x0001F8, "Wrong size on ANiagaraPerfBaselineActor");
static_assert(offsetof(ANiagaraPerfBaselineActor, Controller) == 0x0001E0, "Member 'ANiagaraPerfBaselineActor::Controller' has a wrong offset!");
static_assert(offsetof(ANiagaraPerfBaselineActor, Label) == 0x0001E8, "Member 'ANiagaraPerfBaselineActor::Label' has a wrong offset!");
...
static_assert(sizeof(ANiagaraPreviewBase) == 0x0001E0, "Wrong size on ANiagaraPreviewBase");
...
{
public:
	class UNiagaraSystem*                         System;                                            // 0x01E0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraPreviewGridResetMode                  ResetMode;                                         // 0x01E8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E9[0x7];                                      // 0x01E9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraPreviewAxis*                    PreviewAxisX;                                      // 0x01F0(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNiagaraPreviewAxis*                    PreviewAxisY;                                      // 0x01F8(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class ANiagaraPreviewBase>        PreviewClass;                                      // 0x0200(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SpacingX;                                          // 0x0208(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SpacingY;                                          // 0x020C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumX;                                              // 0x0210(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         NumY;                                              // 0x0214(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UChildActorComponent*>           PreviewComponents;                                 // 0x0218(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(ANiagaraPreviewGrid) == 0x000230, "Wrong size on ANiagaraPreviewGrid");
static_assert(offsetof(ANiagaraPreviewGrid, System) == 0x0001E0, "Member 'ANiagaraPreviewGrid::System' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, ResetMode) == 0x0001E8, "Member 'ANiagaraPreviewGrid::ResetMode' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewAxisX) == 0x0001F0, "Member 'ANiagaraPreviewGrid::PreviewAxisX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewAxisY) == 0x0001F8, "Member 'ANiagaraPreviewGrid::PreviewAxisY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewClass) == 0x000200, "Member 'ANiagaraPreviewGrid::PreviewClass' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, SpacingX) == 0x000208, "Member 'ANiagaraPreviewGrid::SpacingX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, SpacingY) == 0x00020C, "Member 'ANiagaraPreviewGrid::SpacingY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, NumX) == 0x000210, "Member 'ANiagaraPreviewGrid::NumX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, NumY) == 0x000214, "Member 'ANiagaraPreviewGrid::NumY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewComponents) == 0x000218, "Member 'ANiagaraPreviewGrid::PreviewComponents' has a wrong offset!");
