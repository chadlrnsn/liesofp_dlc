...
static_assert(sizeof(USubstanceTexture2D) == 0x0001F0, "Wrong size on USubstanceTexture2D");
static_assert(offsetof(USubstanceTexture2D, ParentInstance) == 0x0001C0, "Member 'USubstanceTexture2D::ParentInstance' has a wrong offset!");
static_assert(offsetof(USubstanceTexture2D, AddressX) == 0x0001C8, "Member 'USubstanceTexture2D::AddressX' has a wrong offset!");
static_assert(offsetof(USubstanceTexture2D, AddressY) == 0x0001C9, "Member 'USubstanceTexture2D::AddressY' has a wrong offset!");
static_assert(offsetof(USubstanceTexture2D, bCooked) == 0x0001CA, "Member 'USubstanceTexture2D::bCooked' has a wrong offset!");
