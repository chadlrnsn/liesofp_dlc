...
{
public:
	uint8                                         Pad_2B8[0x7B8];                                    // 0x02B8(0x07B8)(Fixing Size After Last Property [ Dumper-7 ])
	class UWheeledVehicleMovementComponent*       WheeledVehicleMovementComponent;                   // 0x0A70(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UVehicleAnimInstance) == 0x000A80, "Wrong size on UVehicleAnimInstance");
static_assert(offsetof(UVehicleAnimInstance, WheeledVehicleMovementComponent) == 0x000A70, "Member 'UVehicleAnimInstance::WheeledVehicleMovementComponent' has a wrong offset!");
...
{
public:
	class USkeletalMeshComponent*                 Mesh;                                              // 0x0240(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UWheeledVehicleMovementComponent*       VehicleMovement;                                   // 0x0248(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AWheeledVehicle) == 0x000250, "Wrong size on AWheeledVehicle");
static_assert(offsetof(AWheeledVehicle, Mesh) == 0x000240, "Member 'AWheeledVehicle::Mesh' has a wrong offset!");
static_assert(offsetof(AWheeledVehicle, VehicleMovement) == 0x000248, "Member 'AWheeledVehicle::VehicleMovement' has a wrong offset!");
