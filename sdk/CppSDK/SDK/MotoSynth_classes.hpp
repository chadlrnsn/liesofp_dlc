...
{
public:
	class UMotoSynthPreset*                       MotoSynthPreset;                                   // 0x06B0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RPM;                                               // 0x06B8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USynthComponentMoto) == 0x000770, "Wrong size on USynthComponentMoto");
static_assert(offsetof(USynthComponentMoto, MotoSynthPreset) == 0x0006B0, "Member 'USynthComponentMoto::MotoSynthPreset' has a wrong offset!");
static_assert(offsetof(USynthComponentMoto, RPM) == 0x0006B8, "Member 'USynthComponentMoto::RPM' has a wrong offset!");
